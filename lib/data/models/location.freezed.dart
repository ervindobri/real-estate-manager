...
mixin _$Location {
  ...
  Map<int, String> get adminLevels => throw _privateConstructorUsedError;
...
abstract class $LocationCopyWith<$Res> {
  ...
  $Res call({String nameSpace, Map<int, String> adminLevels});
}
...
class _$_Location with DiagnosticableTreeMixin implements _Location {
  const _$_Location(
      {required this.nameSpace, required final Map<int, String> adminLevels})
      : _adminLevels = adminLevels;
  ...
  final Map<int, String> _adminLevels;
  @override
  Map<int, String> get adminLevels {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_adminLevels);
  }

  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Location(nameSpace: $nameSpace, adminLevels: $adminLevels)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('adminLevels', adminLevels));
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._adminLevels, _adminLevels));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_adminLevels));
...
abstract class _Location implements Location {
  const factory _Location(
      ...
      required final Map<int, String> adminLevels}) = _$_Location;
